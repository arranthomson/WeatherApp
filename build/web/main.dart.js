...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  var get_started = Object.create(dart.library);
  var constants = Object.create(dart.library);
  var welcome = Object.create(dart.library);
  var cities$ = Object.create(dart.library);
  ...
  var T = {
    ...
    BuildContextToWelcome: () => (T.BuildContextToWelcome = dart.constFn(dart.fnType(welcome.Welcome, [framework.BuildContext])))(),
    JSArrayOfWidget: () => (T.JSArrayOfWidget = dart.constFn(_interceptors.JSArray$(framework.Widget)))(),
    CityTobool: () => (T.CityTobool = dart.constFn(dart.fnType(core.bool, [cities$.City])))(),
    ...
    CityToString: () => (T.CityToString = dart.constFn(dart.fnType(core.String, [cities$.City])))(),
    JSArrayOfCity: () => (T.JSArrayOfCity = dart.constFn(_interceptors.JSArray$(cities$.City)))(),
  ...
  dart.defineLazy(CT, {
    ...
    get C9() {
      return C[9] = dart.const({
        __proto__: get_started.GetStarted.prototype,
        [Widget_key]: null
      });
    },
    get C1() {
      return C[1] = dart.const({
        ...
        [MaterialApp_title]: "Climate Adviser",
    ...
    get C11() {
      return C[11] = dart.const({
        __proto__: welcome.Welcome.prototype,
        [Widget_key]: null
      });
    },
    get C15() {
    ...
    get C17() {
      return C[17] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4287673081
      });
    },
    get C18() {
      return C[18] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4288197368
      });
    },
    get C19() {
  ...
  var I = [
    ...
    "package:flutter_app/ui/get_started.dart",
    "package:flutter_app/models/constants.dart",
    "package:flutter_app/ui/welcome.dart",
    "package:flutter_app/models/cities.dart",
    "package:flutter_app/ui/home.dart",
    "package:flutter_app/models/api.dart",
  ...
  get_started.GetStarted = class GetStarted extends framework.StatelessWidget {
    static ['_#new#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      return new get_started.GetStarted.new({key: key});
    }
    build(context) {
      let myConstants = new constants.Constants.new();
      let size = media_query.MediaQuery.of(context).size;
      return new scaffold.Scaffold.new({body: new container.Container.new({width: size.width, height: size.height, color: myConstants.lightprimaryColor.withOpacity(0.5), child: new basic.Center.new({child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.center, crossAxisAlignment: flex.CrossAxisAlignment.center, children: T.JSArrayOfWidget().of([new basic.Flexible.new({child: new image.Image.asset("assets/AppLogo4.png", {fit: box_fit.BoxFit.contain})}), C[10] || CT.C10, new gesture_detector.GestureDetector.new({onTap: dart.fn(() => {
                    navigator.Navigator.pushReplacement(dart.dynamic, T.ObjectN(), context, new page.MaterialPageRoute.new({builder: dart.fn(context => C[11] || CT.C11, T.BuildContextToWelcome())}));
                  }, T.VoidTovoid()), child: new container.Container.new({height: 50, width: size.width * 0.7, decoration: new box_decoration.BoxDecoration.new({color: myConstants.lightprimaryColor, borderRadius: new border_radius.BorderRadius.all(new ui.Radius.circular(18))}), child: C[12] || CT.C12})})])})})})});
    }
  };
  (get_started.GetStarted.new = function(opts) {
    let key = opts && 'key' in opts ? opts.key : null;
    get_started.GetStarted.__proto__.new.call(this, {key: key});
    ;
  }).prototype = get_started.GetStarted.prototype;
  dart.addTypeTests(get_started.GetStarted);
  dart.addTypeCaches(get_started.GetStarted);
  dart.setMethodSignature(get_started.GetStarted, () => ({
    __proto__: dart.getMethods(get_started.GetStarted.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(get_started.GetStarted, I[1]);
  var lightprimaryColor = dart.privateName(constants, "Constants.lightprimaryColor");
  var lightsecondaryColor = dart.privateName(constants, "Constants.lightsecondaryColor");
  constants.Constants = class Constants extends core.Object {
    get lightprimaryColor() {
      return this[lightprimaryColor];
    }
    set lightprimaryColor(value) {
      super.lightprimaryColor = value;
    }
    get lightsecondaryColor() {
      return this[lightsecondaryColor];
    }
    set lightsecondaryColor(value) {
      super.lightsecondaryColor = value;
    }
  ...
  (constants.Constants.new = function() {
    this[lightprimaryColor] = C[17] || CT.C17;
    this[lightsecondaryColor] = C[18] || CT.C18;
    ;
  }).prototype = constants.Constants.prototype;
  dart.addTypeTests(constants.Constants);
  dart.addTypeCaches(constants.Constants);
  dart.setLibraryUri(constants.Constants, I[2]);
  dart.setFieldSignature(constants.Constants, () => ({
    __proto__: dart.getFields(constants.Constants.__proto__),
    lightprimaryColor: dart.finalFieldType(ui.Color),
    lightsecondaryColor: dart.finalFieldType(ui.Color)
  }));
  welcome.Welcome = class Welcome extends framework.StatefulWidget {
    static ['_#new#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      return new welcome.Welcome.new({key: key});
    }
    createState() {
  ...
  (welcome.Welcome.new = function(opts) {
    let key = opts && 'key' in opts ? opts.key : null;
    welcome.Welcome.__proto__.new.call(this, {key: key});
    ;
  }).prototype = welcome.Welcome.prototype;
  dart.addTypeTests(welcome.Welcome);
  dart.addTypeCaches(welcome.Welcome);
  dart.setMethodSignature(welcome.Welcome, () => ({
    __proto__: dart.getMethods(welcome.Welcome.__proto__),
    createState: dart.fnType(framework.State$(welcome.Welcome), [])
  }));
  dart.setLibraryUri(welcome.Welcome, I[3]);
  ...
  welcome._WelcomeState = class _WelcomeState extends framework.State$(welcome.Welcome) {
    build(context) {
      let cities = cities$.City.citiesList[$where](dart.fn(city => city.isDefault === false, T.CityTobool()))[$toList]();
      let selectedCities = cities$.City.getSelectedCities();
      let myConstants = new constants.Constants.new();
      let size = media_query.MediaQuery.of(context).size;
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({automaticallyImplyLeading: false, backgroundColor: myConstants.lightsecondaryColor, title: new text.Text.new(selectedCities[$length][$toString]() + " selected")}), body: new scroll_view.ListView.builder({itemCount: cities[$length], itemBuilder: dart.fn((context, index) => new container.Container.new({margin: C[19] || CT.C19, padding: C[20] || CT.C20, height: size.height * 0.2, width: size.width, decoration: new box_decoration.BoxDecoration.new({border: cities[$_get](index).isSelected === true ? box_border.Border.all({color: myConstants.lightsecondaryColor.withOpacity(0.6), width: 2}) : box_border.Border.all({color: colors.Colors.white}), borderRadius: C[21] || CT.C21, boxShadow: T.JSArrayOfBoxShadow().of([new box_shadow.BoxShadow.new({color: myConstants.lightprimaryColor.withOpacity(0.2), spreadRadius: 5, blurRadius: 7, offset: C[23] || CT.C23})])}), child: new basic.Row.new({children: T.JSArrayOfWidget().of([new gesture_detector.GestureDetector.new({onTap: dart.fn(() => {
                    this.setState(dart.fn(() => {
                      cities[$_get](index).isSelected = !cities[$_get](index).isSelected;
                    }, T.VoidTovoid()));
                  }, T.VoidTovoid()), child: new image.Image.asset(cities[$_get](index).isSelected === true ? "assets/tick-icon.png" : "assets/unchecked-box.png", {width: 30})}), C[24] || CT.C24, new text.Text.new(cities[$_get](index).city, {style: new text_style.TextStyle.new({fontSize: 16, color: cities[$_get](index).isSelected === true ? myConstants.lightprimaryColor : colors.Colors.black54})})])})}), T.BuildContextAndintToContainer())}), floatingActionButton: new floating_action_button.FloatingActionButton.new({backgroundColor: myConstants.lightsecondaryColor, child: C[25] || CT.C25, onPressed: dart.fn(() => {
            navigator.Navigator.pushReplacement(dart.dynamic, T.ObjectN(), context, new page.MaterialPageRoute.new({builder: dart.fn(context => C[27] || CT.C27, T.BuildContextToHome())}));
          }, T.VoidTovoid())})});
    }
    static ['_#new#tearOff']() {
      return new welcome._WelcomeState.new();
  ...
  dart.addTypeCaches(welcome._WelcomeState);
  dart.setMethodSignature(welcome._WelcomeState, () => ({
    __proto__: dart.getMethods(welcome._WelcomeState.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(welcome._WelcomeState, I[3]);
  var city$ = dart.privateName(cities$, "City.city");
  var isSelected$ = dart.privateName(cities$, "City.isSelected");
  var apiLink$ = dart.privateName(cities$, "City.apiLink");
  var isDefault$ = dart.privateName(cities$, "City.isDefault");
  cities$.City = class City extends core.Object {
    get city() {
      return this[city$];
    }
    set city(value) {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      let apiLink = opts && 'apiLink' in opts ? opts.apiLink : null;
      let isDefault = opts && 'isDefault' in opts ? opts.isDefault : null;
      return new cities$.City.new({city: city, isSelected: isSelected, apiLink: apiLink, isDefault: isDefault});
    }
    static getSelectedCities() {
      return cities$.City.citiesList[$where](dart.fn(city => city.isSelected, T.CityTobool()))[$toList]();
    }
    static getSelectedCityNames() {
      let selectedCities = cities$.City.getSelectedCities();
      return selectedCities[$map](core.String, dart.fn(city => city.city, T.CityToString()))[$toList]();
    }
  };
  (cities$.City.new = function(opts) {
    let city = opts && 'city' in opts ? opts.city : null;
    let isSelected = opts && 'isSelected' in opts ? opts.isSelected : null;
    let apiLink = opts && 'apiLink' in opts ? opts.apiLink : null;
    let isDefault = opts && 'isDefault' in opts ? opts.isDefault : null;
    ...
    ;
  }).prototype = cities$.City.prototype;
  dart.addTypeTests(cities$.City);
  dart.addTypeCaches(cities$.City);
  dart.setStaticMethodSignature(cities$.City, () => ['getSelectedCities', 'getSelectedCityNames']);
  dart.setLibraryUri(cities$.City, I[4]);
  dart.setFieldSignature(cities$.City, () => ({
    __proto__: dart.getFields(cities$.City.__proto__),
    city: dart.finalFieldType(core.String),
    isSelected: dart.fieldType(core.bool),
    apiLink: dart.finalFieldType(core.String),
    isDefault: dart.finalFieldType(core.bool)
  }));
  dart.setStaticFieldSignature(cities$.City, () => ['citiesList']);
  dart.defineLazy(cities$.City, {
    /*cities$.City.citiesList*/get citiesList() {
      return T.JSArrayOfCity().of([new cities$.City.new({city: "London", isSelected: true, apiLink: api.VisualCrossingApiKeys.london, isDefault: true}), new cities$.City.new({city: "Manchester", isSelected: false, apiLink: api.VisualCrossingApiKeys.manchester, isDefault: false}), new cities$.City.new({city: "Birmingham", isSelected: false, apiLink: api.VisualCrossingApiKeys.birmingham, isDefault: false}), new cities$.City.new({city: "Leeds", isSelected: false, apiLink: api.VisualCrossingApiKeys.leeds, isDefault: false}), new cities$.City.new({city: "Bradford", isSelected: false, apiLink: api.VisualCrossingApiKeys.bradford, isDefault: false}), new cities$.City.new({city: "Glasgow", isSelected: false, apiLink: api.VisualCrossingApiKeys.glasgow, isDefault: false}), new cities$.City.new({city: "Southampton", isSelected: false, apiLink: api.VisualCrossingApiKeys.southampton, isDefault: false}), new cities$.City.new({city: "Portsmouth", isSelected: false, apiLink: api.VisualCrossingApiKeys.portsmouth, isDefault: false}), new cities$.City.new({city: "Liverpool", isSelected: false, apiLink: api.VisualCrossingApiKeys.liverpool, isDefault: false}), new cities$.City.new({city: "Newcastle", isSelected: false, apiLink: api.VisualCrossingApiKeys.newcastle, isDefault: false}), new cities$.City.new({city: "Nottingham", isSelected: false, apiLink: api.VisualCrossingApiKeys.nottingham, isDefault: false}), new cities$.City.new({city: "Sheffield", isSelected: false, apiLink: api.VisualCrossingApiKeys.sheffield, isDefault: false}), new cities$.City.new({city: "Bristol", isSelected: false, apiLink: api.VisualCrossingApiKeys.bristol, isDefault: false}), new cities$.City.new({city: "Belfast", isSelected: false, apiLink: api.VisualCrossingApiKeys.belfast, isDefault: false}), new cities$.City.new({city: "Leicester", isSelected: false, apiLink: api.VisualCrossingApiKeys.leicester, isDefault: false}), new cities$.City.new({city: "Edinburgh", isSelected: false, apiLink: api.VisualCrossingApiKeys.edinburgh, isDefault: false}), new cities$.City.new({city: "Bournemouth", isSelected: false, apiLink: api.VisualCrossingApiKeys.bournemouth, isDefault: false}), new cities$.City.new({city: "Cardiff", isSelected: false, apiLink: api.VisualCrossingApiKeys.cardiff, isDefault: false}), new cities$.City.new({city: "Coventry", isSelected: false, apiLink: api.VisualCrossingApiKeys.coventry, isDefault: false}), new cities$.City.new({city: "Middlesbrough", isSelected: false, apiLink: api.VisualCrossingApiKeys.middlesbrough, isDefault: false}), new cities$.City.new({city: "Stoke", isSelected: false, apiLink: api.VisualCrossingApiKeys.stoke, isDefault: false}), new cities$.City.new({city: "Blackpool", isSelected: false, apiLink: api.VisualCrossingApiKeys.blackpool, isDefault: false})]);
    },
  ...
  dart.setLibraryUri(home.Home, I[5]);
  home._HomeState = class _HomeState extends framework.State$(home.Home) {
    ...
    updateDateTime() {
      ...
      let formattedDateTime = new date_format.DateFormat.new("dd-MM-yyyy HH:mm:ss").format(now);
      this.setState(dart.fn(() => {
        this.datetime = formattedDateTime;
      }, T.VoidTovoid()));
    }
    fetchWeatherData() {
      return async.async(dart.void, (function* fetchWeatherData() {
        for (let city of cities$.City.getSelectedCities()) {
          let response = (yield http.get(core.Uri.parse(city.apiLink)));
          if (response.statusCode === 200) {
            let data = T.MapOfString$dynamic().as(convert.json.decode(response.body));
            let temperature = T.doubleN().as(dart.dsend(data[$_get]("currentConditions"), '_get', ["temp"]));
            let humidity = T.doubleN().as(dart.dsend(data[$_get]("currentConditions"), '_get', ["humidity"]));
            let windSpeed = T.doubleN().as(dart.dsend(data[$_get]("currentConditions"), '_get', ["windspeed"]));
            this.setState(dart.fn(() => {
              let index = cities$.City.citiesList[$indexOf](city);
              this.temperatures[$_set](index, temperature);
              this.humidities[$_set](index, humidity);
              this.windSpeeds[$_set](index, windSpeed);
            }, T.VoidTovoid()));
          } else {
            core.print("Failed to fetch data for " + city.city);
          }
        }
      }).bind(this));
    }
    build(context) {
      this.selectedCityNames = cities$.City.getSelectedCities()[$map](core.String, dart.fn(city => city.city, T.CityToString()))[$toList]();
      return new scaffold.Scaffold.new({body: new basic.Column.new({crossAxisAlignment: flex.CrossAxisAlignment.stretch, children: T.JSArrayOfWidget().of([new container.Container.new({padding: C[28] || CT.C28, decoration: new box_decoration.BoxDecoration.new({color: this.myConstants.lightprimaryColor}), child: new text.Text.new(this.datetime, {style: new text_style.TextStyle.new({color: colors.Colors.white, fontSize: 20, fontWeight: ui.FontWeight.bold})})}), new basic.Expanded.new({child: new scroll_view.ListView.builder({itemCount: this.selectedCityNames[$length], itemBuilder: dart.fn((context, index) => {
                  let t0, t0$, t0$0, t0$1, t0$2, t0$3;
                  return new basic.Padding.new({padding: C[29] || CT.C29, child: new container.Container.new({width: 150, padding: C[28] || CT.C28, decoration: new box_decoration.BoxDecoration.new({border: cities$.City.citiesList[$_get](index).isSelected === true ? box_border.Border.all({color: this.myConstants.lightsecondaryColor.withOpacity(0.6), width: 2}) : box_border.Border.all({color: colors.Colors.white}), borderRadius: C[21] || CT.C21, boxShadow: T.JSArrayOfBoxShadow().of([new box_shadow.BoxShadow.new({color: this.myConstants.lightprimaryColor.withOpacity(0.2), spreadRadius: 5, blurRadius: 7, offset: C[23] || CT.C23})])}), child: new basic.Column.new({crossAxisAlignment: flex.CrossAxisAlignment.start, children: T.JSArrayOfWidget().of([new text.Text.new(this.selectedCityNames[$_get](index), {style: new text_style.TextStyle.new({fontSize: 18, fontWeight: ui.FontWeight.bold})}), new basic.SizedBox.new({height: 10}), new container.Container.new({height: 50, width: 1 / 0, color: colors.Colors.grey._get(300), margin: new edge_insets.EdgeInsets.only({bottom: 5}), child: new basic.Center.new({child: new text.Text.new("Temperature: " + dart.str((t0$ = (t0 = this.temperatures[$_get](index), t0 == null ? null : dart.toString(t0)), t0$ == null ? "N/A" : t0$)) + " °F", {style: new text_style.TextStyle.new({fontSize: 16, fontWeight: ui.FontWeight.bold})})})}), new container.Container.new({height: 50, width: 1 / 0, color: colors.Colors.grey._get(300), margin: new edge_insets.EdgeInsets.only({bottom: 5}), child: new basic.Center.new({child: new text.Text.new("Humidity: " + dart.str((t0$1 = (t0$0 = this.humidities[$_get](index), t0$0 == null ? null : dart.toString(t0$0)), t0$1 == null ? "N/A" : t0$1)) + "%", {style: new text_style.TextStyle.new({fontSize: 16, fontWeight: ui.FontWeight.bold})})})}), new container.Container.new({height: 50, width: 1 / 0, color: colors.Colors.grey._get(300), margin: new edge_insets.EdgeInsets.only({bottom: 5}), child: new basic.Center.new({child: new text.Text.new("Wind Speed: " + dart.str((t0$3 = (t0$2 = this.windSpeeds[$_get](index), t0$2 == null ? null : dart.toString(t0$2)), t0$3 == null ? "N/A" : t0$3)) + " mph", {style: new text_style.TextStyle.new({fontSize: 16, fontWeight: ui.FontWeight.bold})})})})])})})});
  ...
  (home._HomeState.new = function() {
    this.myConstants = new constants.Constants.new();
    this.temperatures = T.ListOfdoubleN().filled(cities$.City.citiesList[$length], null);
    this.humidities = T.ListOfdoubleN().filled(cities$.City.citiesList[$length], null);
    this.windSpeeds = T.ListOfdoubleN().filled(cities$.City.citiesList[$length], null);
    this.datetime = "";
    this.selectedCityNames = T.JSArrayOfString().of([]);
  ...
  dart.setMethodSignature(home._HomeState, () => ({
    ...
    updateDateTime: dart.fnType(dart.void, []),
    fetchWeatherData: dart.fnType(async.Future$(dart.void), []),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(home._HomeState, I[5]);
  dart.setFieldSignature(home._HomeState, () => ({
    __proto__: dart.getFields(home._HomeState.__proto__),
    myConstants: dart.fieldType(constants.Constants),
    temperatures: dart.fieldType(core.List$(dart.nullable(core.double))),
    humidities: dart.fieldType(core.List$(dart.nullable(core.double))),
    windSpeeds: dart.fieldType(core.List$(dart.nullable(core.double))),
    datetime: dart.fieldType(core.String),
    selectedCityNames: dart.fieldType(core.List$(core.String))
  }));
  api.VisualCrossingApiKeys = class VisualCrossingApiKeys extends core.Object {
    static ['_#new#tearOff']() {
      return new api.VisualCrossingApiKeys.new();
    }
  };
  (api.VisualCrossingApiKeys.new = function() {
    ;
  }).prototype = api.VisualCrossingApiKeys.prototype;
  dart.addTypeTests(api.VisualCrossingApiKeys);
  dart.addTypeCaches(api.VisualCrossingApiKeys);
  dart.setLibraryUri(api.VisualCrossingApiKeys, I[6]);
  dart.setStaticFieldSignature(api.VisualCrossingApiKeys, () => ['london', 'manchester', 'birmingham', 'leeds', 'bradford', 'glasgow', 'southampton', 'portsmouth', 'liverpool', 'newcastle', 'nottingham', 'sheffield', 'bristol', 'belfast', 'brighton', 'leicester', 'edinburgh', 'bournemouth', 'cardiff', 'coventry', 'middlesbrough', 'stoke', 'blackpool']);
  dart.defineLazy(api.VisualCrossingApiKeys, {
    /*api.VisualCrossingApiKeys.london*/get london() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/London?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.manchester*/get manchester() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/manchester?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.birmingham*/get birmingham() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/Birmingham%20?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.leeds*/get leeds() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/Leeds?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.bradford*/get bradford() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/bradford?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.glasgow*/get glasgow() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/glasgow?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.southampton*/get southampton() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/southampton?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.portsmouth*/get portsmouth() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/portsmouth?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.liverpool*/get liverpool() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/liverpool?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.newcastle*/get newcastle() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/newcastle-on-tyne?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.nottingham*/get nottingham() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/nottingham?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.sheffield*/get sheffield() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/sheffield?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.bristol*/get bristol() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/bristol?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.belfast*/get belfast() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/belfast?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.brighton*/get brighton() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/brighton?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.leicester*/get leicester() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/leicester?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.edinburgh*/get edinburgh() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/edinburgh?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.bournemouth*/get bournemouth() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/bournemouth?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.cardiff*/get cardiff() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/cardiff?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.coventry*/get coventry() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/coventry?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.middlesbrough*/get middlesbrough() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/middlesbrough?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.stoke*/get stoke() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/stoke-on-trent?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    },
    /*api.VisualCrossingApiKeys.blackpool*/get blackpool() {
      return "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/blackpool?unitGroup=us&key=JCFL4SDZMCLU8XNFRHNTZSUG8&contentType=json";
    }
  }, false);
  ...
  dart.trackLibraries("zapp_user_main", {
    ...
    "package:flutter_app/ui/get_started.dart": get_started,
    "package:flutter_app/models/constants.dart": constants,
    "package:flutter_app/ui/welcome.dart": welcome,
    "package:flutter_app/models/cities.dart": cities$,
    "package:flutter_app/ui/home.dart": home,
    "package:flutter_app/models/api.dart": api,
